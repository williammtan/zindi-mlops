...
1. First, make sure you have the trained model and tokenizer locally available. To get these, you can run the ```download_model.py``` script in the main directory.
...
1. Then build the container locally and give it a tag
    ...
    ```bash
    docker build -t local/highwind-examples/nllb-600m:latest .
    ```
